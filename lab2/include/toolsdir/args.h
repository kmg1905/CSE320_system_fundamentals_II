...
extern int get_args (int argc, char **argv, Bool print_msg, Bool dup_error);
...
extern Bool check_option_args (char achar, int themin, int themax);

        /* char achar; int min; int max; */

#define ALL_LEGAL 0

int option_to_index (char );
...
extern void error_message (char *progname, char ** argv, int i, char *usage);
